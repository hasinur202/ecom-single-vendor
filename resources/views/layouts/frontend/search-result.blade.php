...
<main>
    <div class="top_banner">
        ...
        <img src="assets/img/bg_cat_shoes.jpg" class="img-fluid" alt="">
    </div>
    <!-- /top_banner -->
                ...
                <div class="row small-gutters">
                    ...
                    <div class="col-6 col-md-4">
                        <div class="grid_item">
                            ...
                            <figure>
                                <a href="product-detail-1.html">
                                    <img class="img-fluid lazy" src="assets/img/products/product_placeholder_square_medium.jpg" data-src="assets/img/products/shoes/9.jpg" alt="">
                                </a>
                            </figure>
                            <a href="product-detail-1.html">
                                <h3>Armor 720</h3>
